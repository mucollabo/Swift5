...
let charlesPoint: CoordinatePoint = CoordinatePoint(x: 10, y: 5)
...
let charlesPosition: Position = Position(name: "charles", currentPoint: charlesPoint)

//print(charlesPosition.name, charlesPosition.point)
